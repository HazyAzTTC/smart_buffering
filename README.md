...
<p>-**MFMI** ==> "Malloc Failed Making Input" means that the malloc used for creating the buffer storing your input failed... Responsible function is "char \*input_init(void)" in src/main.c.<br>
